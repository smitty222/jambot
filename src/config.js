...
export const env = {
  ...
  f1PurseFloorRookie: getNumberEnv('F1_PURSE_FLOOR_ROOKIE', 5000),
  f1PurseFloorOpen: getNumberEnv('F1_PURSE_FLOOR_OPEN', 12000),
  f1PurseFloorElite: getNumberEnv('F1_PURSE_FLOOR_ELITE', 30000),

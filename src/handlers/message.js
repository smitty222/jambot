...
import { handleCarEntryAttempt, handleBetCommand, startF1Race, handleBuyCar, handleMyCars, handleRepairCar, handleTeamCommand, handleF1Help, } from '../games/f1race/handlers/commands.js'
...
- /cheers`
  ...
  } else if (payload.message.startsWith('/jester')) {
  ...
  } else if (payload.message.startsWith('/tvguy')) {
    await handleTVguyCommand(payload.sender, room, postMessage)
  } else if (payload.message.startsWith('/pinkblanket' || '/blanket')) {
  ...
  } else if (payload.message.startsWith('/pajama')) {

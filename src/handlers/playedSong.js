    ...
    try {
        ...
        if (currentSong && currentSong.spotifyUrl) {
            try {
                ...
                const artistName = songData.album?.artistName;
         
                
                // Now ask a question to the AI about this song
                const question = `Is ${currentSong.trackName} by ${artistName} a cover of another song or an original? If it's a cover please respond with brief information about it and the original song. If it's not a cover please respond with from what I can tell, this song is not a cover along with brief information about`;
